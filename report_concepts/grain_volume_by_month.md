...
MRTIS commit `95ff34b` · window **2023-08-01 → 2026-07-31** (trailing 36 months, anchored on the data's last date `2026-07-31`, not on today) · scope **9 grain elevators + MGMT**

> **Read the two denominators before the numbers.** Ship count is complete: every one of the **4,262 loadings** (2,471 distinct vessels) is counted. Tonnage is not — tons exist only where an FGIS certificate matched, which is **4,009 of 4,262 loadings (94.1%)**. The tonnage column therefore measures a *subset* of the ships in the same row. Comparing tons across facilities without reading the coverage column will mislead you — see `ISSUES.md` I-2.

**Grain moved (FGIS-certified, in-scope, 36 months): 175,648,810 metric tonnes** across 4,009 certified loadings.
...
| 2025-06 | 113 | 112 | 104 | 92% | 3,915,913 | 37,653 |
| 2025-07 | 118 | 115 | 109 | 92% | 4,285,460 | 39,316 |
| 2025-08 | 132 | 127 | 128 | 97% | 5,109,646 | 39,919 |
| 2025-09 | 137 | 132 | 132 | 96% | 5,852,149 | 44,334 |
| 2025-10 | 132 | 128 | 123 | 93% | 5,676,764 | 46,153 |
| 2025-11 | 129 | 122 | 124 | 96% | 5,559,953 | 44,838 |
| 2025-12 | 128 | 121 | 122 | 95% | 5,755,535 | 47,177 |
| 2026-01 | 146 | 143 | 143 | 98% | 6,865,314 | 48,009 |
| 2026-02 | 118 | 115 | 114 | 97% | 5,088,321 | 44,634 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| Zen-Noh | Elevator | 835 | 699 | 832 | 99.6% | 43,734,065 | 52,565 |
| ADM AMA | Elevator | 589 | 491 | 559 | 94.9% | 21,350,847 | 38,195 |
| ADM Destrehan | Elevator | 525 | 429 | 462 | 88.0% | 11,853,166 | 25,656 |
| Cargill Reserve | Elevator | 487 | 420 | 465 | 95.5% | 20,676,682 | 44,466 |
| Cargill Westwego | Elevator | 384 | 354 | 381 | 99.2% | 20,029,118 | 52,570 |
| CHS Myrtle Grove | Elevator | 363 | 325 | 363 | 100.0% | 13,600,530 | 37,467 |
| ADM Reserve | Elevator | 343 | 320 | 342 | 99.7% | 19,452,942 | 56,880 |
| Bunge Destrehan | Elevator | 306 | 278 | 262 | 85.6% | 10,738,785 | 40,988 |
| LDC Port Allen | Elevator | 228 | 203 | 227 | 99.6% | 10,146,108 | 44,697 |
...
| Zen-Noh | 835 | 832 | · | 3 |
| ADM AMA | 589 | 559 | · | 30 |
| ADM Destrehan | 525 | 462 | · | 63 |
| Cargill Reserve | 487 | 465 | · | 22 |
| Cargill Westwego | 384 | 381 | · | 3 |
| CHS Myrtle Grove | 363 | 363 | · | · |
| ADM Reserve | 343 | 342 | · | 1 |
| Bunge Destrehan | 306 | 262 | · | 44 |
| LDC Port Allen | 228 | 227 | · | 1 |
| MGMT | 144 | 58 | 86 | · |
...
|---|---:|---:|---:|---:|
| Zen-Noh | 122 | 284 | 280 | 149 |
| ADM AMA | 63 | 210 | 206 | 110 |
| ADM Destrehan | 65 | 157 | 191 | 112 |
| Cargill Reserve | 55 | 161 | 163 | 108 |
| Cargill Westwego | 54 | 116 | 134 | 80 |
| CHS Myrtle Grove | 39 | 102 | 157 | 65 |
| ADM Reserve | 45 | 126 | 111 | 61 |
| Bunge Destrehan | 43 | 96 | 105 | 62 |
| LDC Port Allen | 30 | 77 | 78 | 43 |
| MGMT | 12 | 62 | 45 | 25 |
