...
MRTIS commit `61c899b` · window **2023-08-01 → 2026-07-31** · scope **9 grain elevators + MGMT** · leg-level agency (`port_call_leg.agency`) — the agency that brought the vessel in owns the leg (`docs/BUSINESS_RULES.md` §6)
