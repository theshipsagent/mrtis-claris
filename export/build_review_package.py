...
PORT_CALL_DESC = {
    ...
    "vessel_key": "Internal MRTIS vessel key (positional, not a stable identity -- see docs/BUSINESS_RULES.md and MRTIS OPEN_QUESTIONS.md #10).",
    ...
    "tpc": "Tonnes per centimetre immersion, from the ships register. Zero is sometimes a real value, sometimes a data gap -- see docs/BUSINESS_RULES.md.",
    ...
    "berth_stop_count": "Count of real (non-artifact) berth stops across the whole call.",
...
PORT_CALL_LEG_DESC = {
    ...
    "vessel_key": "Internal MRTIS vessel key (positional -- see port_call.vessel_key note).",
    ...
    "activity": "'Load' / 'Discharge' / 'No Cargo' / blank (unresolved -- never guessed). See docs/BUSINESS_RULES.md section 4.",
    ...
    "berth_stop_count": "Real (non-artifact) berth stops in this leg.",
    ...
    "first_berth_zone": "Raw source zone name of the leg's first berth stop.",
    "first_berth_facility": "Canonical facility name of the leg's first berth stop.",
    "facility_type": "Facility type of the leg's first berth stop (Elevator / Tank Storage / General Cargo / etc). Decides fee rule R5.",
    ...
    "berth_hours": "Hours alongside the berth.",
...
PORT_CALL_EVENT_DESC = {
    ...
    "agency_fee": "COMPARISON-ONLY. The old per-departure fee for this specific sailing, unchanged. NOT the billable figure -- that lives on port_call_leg.agency_fee. Summing this column over-bills by roughly 17% (see docs/BUSINESS_RULES.md section 9.1).",
}
