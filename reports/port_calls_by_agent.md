...
MRTIS commit `27d8a19` · leg-level agency (`port_call_leg.agency`) -- the agency that brought the vessel in owns the leg (docs/BUSINESS_RULES.md §6). 37 distinct agencies with billable legs; top 20 shown here, full list in the CSV.
